...
RELATIVE_URL=com/convergencelabs/convergence-server-universal/$CONVERGENCE_SERVER_VERSION/convergence-server-universal-$CONVERGENCE_SERVER_VERSION.tgz
...
DOWNLOAD_URL=$REPO_BASE_URL/$RELATIVE_URL
